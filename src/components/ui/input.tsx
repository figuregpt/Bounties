...
function Input({
  ...
  // For number inputs, blur on wheel scroll so the page scrolls normally
  // and the value can't be accidentally adjusted by the mouse wheel. We
  // chain to any caller-supplied onWheel after blurring.
  const handleWheel =
    type === "number"
